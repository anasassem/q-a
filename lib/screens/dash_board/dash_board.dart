        ...
        builder: (context, state) {
          return ListView(
            ...
            children: [
              ...
              GenericTextField(
                max: 10,
                controller: controller.termsAnnConditionsAr,
                ...
                textColor: Colors.black,
                validate: (value) => value!.validateEmpty(),
                label: "${tr("termsAndConditions", context)} ar",
                margin: const EdgeInsets.only(bottom: 15),
              ),     Gaps.vGap15,
              GenericTextField(
                max: 10,
                controller: controller.termsAnnConditionsEn,
                fieldTypes: FieldTypes.rich,
                focusBorderColor: primaryColor,
                enableBorderColor: Colors.transparent,
                type: TextInputType.multiline,
                ...
                textColor: Colors.black,
                validate: (value) => value!.validateEmpty(),
                label: "${tr("termsAndConditions", context)} en",
                margin: const EdgeInsets.only(bottom: 15),
              ),
              Gaps.vGap15,
              GenericTextField(
                max: 10,
                controller: controller.privacyPolicyAr,
                fieldTypes: FieldTypes.rich,
                focusBorderColor: primaryColor,
                enableBorderColor: Colors.transparent,
                type: TextInputType.text,
                ...
                textColor: Colors.black,
                validate: (value) => value!.validateEmpty(),
                label: "${tr("privacyPolicy", context)} ar",
                margin: const EdgeInsets.only(bottom: 15),
              ),
              Gaps.vGap15,
              GenericTextField(
                max: 10,
                controller: controller.privacyPolicyEn,
                fieldTypes: FieldTypes.rich,
                focusBorderColor: primaryColor,
                enableBorderColor: Colors.transparent,
                type: TextInputType.text,
                ...
                textColor: Colors.black,
                validate: (value) => value!.validateEmpty(),
                label:  "${tr("privacyPolicy", context)} en",
                margin: const EdgeInsets.only(bottom: 15),
              ),
              Padding(
                padding: const EdgeInsets.only(top: 10, bottom: 10).r,
