...
class Dimens {
  ...
  static EdgeInsets paddingOnlyTop3PX = const EdgeInsets.only(top: 3).r;
  static EdgeInsets paddingOnlyTop5PX = const EdgeInsets.only(top: 5).r;
  static EdgeInsets paddingOnlyTop8PX = const EdgeInsets.only(top: 8).r;
  static EdgeInsets paddingOnlyTop10PX = const EdgeInsets.only(top: 10).r;
  static EdgeInsets paddingOnlyTop15PX = const EdgeInsets.only(top: 15).r;
  static EdgeInsets paddingOnlyTop20PX = const EdgeInsets.only(top: 20).r;
  static EdgeInsets paddingOnlyTop8Bottom20PX = const EdgeInsets.only(top: 8,bottom: 20).r;
  static EdgeInsets paddingOnlyTop15Bottom10PX = const EdgeInsets.only(top: 15,bottom: 10).r;

  static EdgeInsets marginH50v20 = const EdgeInsets.symmetric(horizontal: 50, vertical: 20).r;
  static EdgeInsets marginH20v10 = const EdgeInsets.symmetric(horizontal: 20, vertical: 10).r;
}
